...
const CustomInputForm = ({ key, type, name, onChange, label, value, placeholder, textError, leftIcon, rightIcon }) => {
    return (
        <div className="inputContent" key={key}>
            <label htmlFor={name} className="inputContent__label"> {label} </label>
