...
const SearchSubPage = () => {
    ...
    const searchFilter = useSelector(store => store.setSearcRestaurantsReducer) // Capute input search restaurants.
            ...
            <div className="explorerContent__restaurants">
                {
                    restaurants.filter((restaurant => {
                        if (restaurant.name.toLowerCase().startsWith(searchFilter.toLowerCase()) 
                                || restaurant.name.toLowerCase().endsWith(searchFilter.toLowerCase()) 
